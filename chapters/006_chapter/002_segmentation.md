...
La segmentazione ha anche un lato pericoloso. Se si continua a dividere il dataset per paese, device, canale, prodotto, fascia d'eta', giorno della settimana e ora, prima o poi si trovera' qualcosa di "interessante" anche per puro caso.

Inoltre, segmenti troppo piccoli diventano instabili. Un conversion rate del 12% su 25 sessioni non ha lo stesso peso di un 4,1% su 250.000 sessioni.
...
> Quale suddivisione potrebbe rivelare un meccanismo diverso o suggerire un'azione diversa?

La differenza sembra sottile. In pratica separa l'analisi dalla semplice esplorazione di filtri.
