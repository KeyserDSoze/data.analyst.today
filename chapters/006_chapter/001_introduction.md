# Capitolo 6 - Segmentazione, coorti, funnel, retention e churn

## Introduzione

Le medie generali sono utili per orientarsi. Sono anche uno dei modi più rapidi per non vedere ciò che conta.

Un'azienda può avere una retention mensile del 72% e, nello stesso momento, perdere quasi tutti i clienti acquisiti da una specifica campagna. Un funnel può convertire al 4,8% in media mentre il traffico mobile da paid social converte all'1,9% e quello desktop organico al 9,7%. Un tasso di churn stabile può nascondere un deterioramento progressivo delle nuove coorti, compensato temporaneamente da clienti storici molto fedeli.

Questo capitolo serve a imparare a rompere le medie.

Segmentazione, coorti, funnel, retention e churn non sono tecniche separate. Sono modi diversi di rispondere alla stessa domanda:
...
- per quali utenti nuovi o ricorrenti?
- per quali coorti di acquisizione?
