...
- review capitolo-per-capitolo;
- audit globale delle fonti e dei claim;
- distinzione tra casi reali documentati e casi simulati/compositi;
- controlli automatici di struttura e normalizzazione;
...
Le informazioni su copyright e licenza vengono definite a livello di release e repository. Questa nota non introduce né modifica autonomamente condizioni di utilizzo del contenuto.
